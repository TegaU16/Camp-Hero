...
namespace Game.Players
{
    public class PlayerAttributes : MonoBehaviour
    {
        ...
        public float StaminaRegenRate => 1f + PlayerStatsManager.Instance.stats.endurance.Value * 0.05f;
        public float CritChanceMultiplier => 1f + PlayerStatsManager.Instance.stats.luck.Value * 0.005f;
        public float MovementSpeedMultiplier => 1f + PlayerStatsManager.Instance.stats.speed.Value * 0.02f;
    }
}
