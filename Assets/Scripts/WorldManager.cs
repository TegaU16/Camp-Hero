...
namespace Worlds
{
    public class WorldManager : MonoBehaviour
    {
        ...
        // Called by play world button in main menu
        ...
        // Called by delete button in main menu
        public void ToggleDeleteConfirm(bool open)
        {
            deleteConfirmMenu.SetActive(open);
            Button[] buttonsInScene = FindObjectsByType<Button>(FindObjectsSortMode.None);

            Utility.DisableButtonsOutside(deleteConfirmMenu.transform, buttonsInScene, open);
        }

        // Called by delete button in delete confirm menu
        ...
        // Called by retry button in main menu
